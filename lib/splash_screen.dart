...
class _SplashScreenState extends State<SplashScreen> with TickerProviderStateMixin {
  ...
  final List<String> _facts = [
    "Did you know? Avocados are technically a fruit, specifically a single-seeded berry.",
    "Did you know? Almonds belong to the peach family.",
    ...
    "Did you know? Dark chocolate contains powerful antioxidants that can improve heart health.",
    ...
    "Did you know? Peanuts aren't technically nuts; they're legumes."
  ];
  ...
  void initState() {
    super.initState();
    _randomFact = _facts[Random().nextInt(_facts.length)];
  ...
  Future<void> _runAnimationSequence() async {
    ...
    // Initialize Auth Service while animating
    ...
    // Hold briefly to let user read the fact
